...
export default {
  ...
  methods: {
      ...
      this.axios
        ...
        .then((res) => {
          ...
          if (status == 0) {
            ...
            this.$store.isUserLogin = true;
            this.$store.centerActive = true;
            this.$store.isLogin = false;
            this.$store.name = this.username;
            console.log(
              this.$store.isUserLogin,
              this.$store.centerActive,
              this.$store.isLogin
            );
          } else {
            alert("登录失败");
    ...
    handleToRegister() {
      ...
      this.$store.isLogin = false;
      this.$store.registerActive = true;
      this.$store.isinRegister = true;
    },
  },
};
</script>
